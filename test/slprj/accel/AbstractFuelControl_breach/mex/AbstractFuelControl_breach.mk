...
MODULES                 = AbstractFuelControl_breach_acc.c AbstractFuelControl_breach_acc_data.c rt_nonfinite.c c_mexapi_version.c
PRODUCT                 = $(RELATIVE_PATH_TO_ANCHOR)/AbstractFuelControl_breach_acc.mexa64
MAKEFILE                = AbstractFuelControl_breach.mk
MATLAB_ROOT             = /usr/local/MATLAB/R2024a
ALT_MATLAB_ROOT         = /usr/local/MATLAB/R2024a
START_DIR               = /home/sekars/Documents/stage/test
S_FUNCTIONS_LIB         = 
NUMST                   = 4
NCSTATES                = 6
COMPUTER                = GLNXA64
...
SYSTEM_LIBS             = -L"/usr/local/MATLAB/R2024a/bin/glnxa64" -lmwipp -lut -lmwmathutil -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwsl_fileio -lmwsigstream -lmwslexec_simlog -lmwsl_AsyncioQueue -lmwsf_runtime -lmwsimulink -lmwslexec_simbridge -lmwstringutil -lemlrt -lmwslio_core -lmwslio_clients -lmwsl_services -lmx -lmex
...
MODELLIB                  = AbstractFuelControl_breach_acc.mexa64
MODELREF_LINK_LIBS        = 
...
AbstractFuelControl_breach_acc.o : $(START_DIR)/slprj/accel/AbstractFuelControl_breach/AbstractFuelControl_breach_acc.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/AbstractFuelControl_breach/AbstractFuelControl_breach_acc.c

AbstractFuelControl_breach_acc_data.o : $(START_DIR)/slprj/accel/AbstractFuelControl_breach/AbstractFuelControl_breach_acc_data.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/AbstractFuelControl_breach/AbstractFuelControl_breach_acc_data.c

rt_nonfinite.o : $(START_DIR)/slprj/accel/AbstractFuelControl_breach/rt_nonfinite.c
	$(CC) -c $(CFLAGS) $(GCC_WALL_FLAG_MAX) $(START_DIR)/slprj/accel/AbstractFuelControl_breach/rt_nonfinite.c
